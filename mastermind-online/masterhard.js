...
function generateCode()
{
    ...
    for(i=0;i<mainCode.length;i++){
        switch (mainCode[i]) {
            case 1: mainCode[i] = "saddlebrown";
            break;
            case 2: mainCode[i] = "red";
            break;
            case 3: mainCode[i] = "orange";
            break;
            case 4: mainCode[i] = "yellow";
            break;
            case 5: mainCode[i] = "green";
            break;
            case 6: mainCode[i] = "blue";
            break;
            case 7: mainCode[i] = "purple";
            break;
        }
    }
